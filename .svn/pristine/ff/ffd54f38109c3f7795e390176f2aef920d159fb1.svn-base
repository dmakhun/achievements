...
<div class="row">
	<div class="col-md-3">
		<div class="panel panel-default">
			...
			<table class="table">
				<c:forEach var="item" items="${competencelist}"><tr><td>${item.name}</td></tr></c:forEach>
			</table>
		</div>
	</div>
				...
				<div class="row">
					<div class="col-md-10">
						<div class="form-group">
							<input class="form-control" type="text" name="competenceName" placeholder=<spring:message code="competence.name"/> />
						</div>
					</div>
					<div class="col-md-2">
						<div class="form-group">
